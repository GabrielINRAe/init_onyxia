git clone https://oauth2:LzP8sARiWJhuziwPFfYo@forge.inrae.fr/dynafor/dev-test/gabriel-orabona/stage_pnr_dynafor.git
chown -R onyxia:users stage_pnr_dynafor/
git clone https://oauth2:LzP8sARiWJhuziwPFfYo@forge.inrae.fr/dynafor/dev-test/lucas/spectral-indices.git
